...
from src.consititutive_model.finite_strain.HenckyElastic import *
from src.mpm.materials.ConstitutiveModelBase import ConstitutiveModelBase
from src.mpm.Simulation import Simulation
from src.utils.ObjectIO import DictIO


class HenckyElastic(ConstitutiveModelBase):
    def __init__(self, sims: Simulation):
        super().__init__()
        self.is_elastic = True
        self.add_material(sims.max_material_num, sims.material_type, sims.contact_detection, HenckyElasticModel)
