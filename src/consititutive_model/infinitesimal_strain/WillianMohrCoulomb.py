...
from src.utils.constants import DELTA2D, DELTA, PI, FTOL, LTOL, MAXITS, NSUB, EPS, STOL, dTmin
...
class WillianMohrCoulombModel:
    ...
    @ti.func
    def ComputePlasticModulus(self):
        pass
    ...
    def ImplicitIntegration(self, np, previous_stress, de, dw, stateVars):
        ...
        if yield_state_trial > 0:
            ...
            __, dp_dq, dg_dsigma = self.ComputeDgDsigma(yield_state, stress)
