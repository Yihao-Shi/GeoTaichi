...
from src.utils.constants import (DELTA, DELTA2D, Threshold, ZEROVEC6f, itrstep, substep, Ftolerance, Gtolerance)
...
class CohesiveModifiedCamClayModel:
    ...
    def add_material(self, density, possion, m_theta, kappa, lambda_, e_ref, p_ref, ocr, subloading, subloading_u, bonding, s_h, mc_a, mc_b, mc_c, mc_d, m_degradation, m_shear):
