...
from geotaichi.utils.TypeDefination import (vec2f, vec3f, vec3i, mat3x3, vec4f, vec5f, vec6f, vec8f,
...
STOL = 1.e-9 # stress tolerance
LTOL = 1.e-6 # detecting tolerance
MAXITS = 30  # maximum iteration number
NSUB = 10
dTmin = 1e-4
