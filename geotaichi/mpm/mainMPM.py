...
from geotaichi.mpm.engines.ULExplicitEngine import ULExplicitEngine
from geotaichi.mpm.GenerateManager import GenerateManager
from geotaichi.mpm.MPMBase import Solver
from geotaichi.mpm.PostPlot import write_vtk_file
from geotaichi.mpm.Recorder import WriteFile
...
class MPM(object):
    ...
    def set_configuration(self, **kwargs):
        ...
        self.sims.set_mpm_coupling(DictIO.GetAlternative(kwargs, "coupling", False))
        
    def set_implicit_solver_parameters(self, implicit_parameters):    
        self.sims.set_implicit_parameters(implicit_parameters)
