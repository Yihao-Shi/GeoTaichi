...
from geotaichi.dem.BaseStruct import (HistoryRollingContactTable, RollingContactTable)
...
from geotaichi.utils.ScalarFunction import EffectiveValue, round32
from geotaichi.utils.TypeDefination import u1, vec3f
...
class LinearRollingSurfaceProperty:
    ...
    # ========================================================= # 
    @ti.func
    def _particle_wall_force_assemble(self, nc, dt, particle, wall, cplist, hist_cplist, hist_particle_wall, find_history_overlap: ti.template()):
        end1, end2 = cplist[nc].endID1, cplist[nc].endID2
