...
def flip_ctrlpts_u(ctrlpts, size_u, size_v, size_w=None):
    ...
    if size_w is None:
        ...
        for i in range(0, size_w):
            for j in range(0, size_u):
                for k in range(0, size_v):
                    temp = [float(c) for c in ctrlpts[j + (k * size_u) + (i * size_u * size_v)]]
                    new_ctrlpts.append(temp)

    return new_ctrlpts


def flip_ctrlpts(ctrlpts, size_u, size_v, size_w=None):
        ...
        for i in range(0, size_w):
            for j in range(0, size_v):
                for k in range(0, size_u):
                    temp = [float(c) for c in ctrlpts[j + (k * size_v) + (i * size_u * size_v)]]
                    new_ctrlpts.append(temp)
